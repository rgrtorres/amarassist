    ...
    <div class="card-body">
        ...
        <form action="" method="POST">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" placeholder="Name" aria-label="Username" value="Renan Torres" aria-describedby="basic-addon1">
            </div>
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" placeholder="Postal Code" aria-label="Username" aria-describedby="basic-addon1">
            </div>
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" placeholder="Address" aria-label="Username" disabled aria-describedby="basic-addon1">
            </div>
